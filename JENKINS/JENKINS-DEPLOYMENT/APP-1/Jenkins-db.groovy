pipeline {
    ...
    environment {
        ...
        DB_SECRET_YAML =
            "APP-1/kube/db-secret.yaml"

        DB_CONFIGMAP_YAML =
            "APP-1/kube/db-configmap.yaml"

        DB_STORAGECLASS_YAML =
            "APP-1/kube/db-storageclass.yaml"

        DB_PVC_YAML =
            "APP-1/kube/db-pvc.yaml"

        DB_DEPLOYMENT_YAML =
            "APP-1/kube/db-deployment.yaml"

        DB_SERVICE_YAML =
            "APP-1/kube/db-service.yaml"
    }
            ...
            steps {
                ...
                script {
                    ...
                    docker.withRegistry(
                        ...
                        sh """
                            docker build \
                                -f APP-1/nginx-flask-mysql/db/Dockerfile \
                                -t ${image} \
...
def deployDB(
    ...
    echo "Image        : ${image}"
    echo "Secret       : ${secretYaml}"
    echo "ConfigMap    : ${configMapYaml}"
